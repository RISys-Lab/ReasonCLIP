#!/bin/bash
#SBATCH --job-name=ov15_rs1-1_stage15
...
#SBATCH --output=ov15_rs1-1_stage15_%j.out
#SBATCH --error=ov15_rs1-1_stage15_%j.err
...
STAGE1_MODEL_PATH="${STAGE1_MODEL_PATH:-${REPO_ROOT}/outputs/llava_ov15/rs1-1/stage1_alignment}"
DATA_PATH="${DATA_PATH:-${REPO_ROOT}/data/LLaVA-OneVision-1.5-Mid-Training-Webdataset-Quick-Start-3M}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/llava_ov15/rs1-1/stage1_5_midtraining}"
...
RUNTIME_CACHE_DIR="${SLURM_TMPDIR:-/tmp}/llava-ov15-rs1-1-stage15-${SLURM_JOB_ID:-$$}"
