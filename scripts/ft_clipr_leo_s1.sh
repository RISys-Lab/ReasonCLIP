#!/bin/bash
#SBATCH --job-name=clipr_b32_ft_s1
...
#SBATCH --qos=normal
#SBATCH --output=clipr_b32_ft_s1.out
#SBATCH --error=clipr_b32_ft_s1.err
...
OUT_DIR="$WORK/fmohamma/CLIP-R/weights/clip_r_b32_s1"
