...
python dataset/gen_vllm_ray.py \
    --model_source $WORK/CLIP-R/data/Qwen3-32B \
    --data_path $WORK/data/Xkev-LLaVA-CoT-100k-parquet/default/train/ \
    --output_path $WORK/CLIP-R/outputs/ReasonPro/train_data_vllm.parquet \
    --batch_size 4 \
    --max_model_len 8192 \
