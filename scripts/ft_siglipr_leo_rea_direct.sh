#!/bin/bash
#SBATCH --job-name=siglip2_r_rea_direct
...
#SBATCH --qos=normal
#SBATCH --output=siglip2_r_rea_direct.out 
#SBATCH --error=siglip2_r_rea_direct.err
...
OUT_DIR="$WORK/fmohamma/CLIP-R/weights/siglip2_r_rea_direct"
