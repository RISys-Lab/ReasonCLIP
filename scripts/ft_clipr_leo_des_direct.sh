#!/bin/bash
#SBATCH --job-name=clipr_des_direct
...
#SBATCH --qos=normal
#SBATCH --output=clipr_des_direct.out 
#SBATCH --error=clipr_des_direct.err
...
OUT_DIR="$WORK/fmohamma/CLIP-R/weights/clip_r_des_direct"
