#!/bin/bash
#SBATCH --job-name=ov15_rsiglip_s15
...
#SBATCH --output=ov15_rsiglip_s15_%j.out
#SBATCH --error=ov15_rsiglip_s15_%j.err
...
STAGE1_MODEL_PATH="${STAGE1_MODEL_PATH:-${REPO_ROOT}/outputs/llava_ov15/reasonsiglip/stage1_alignment}"
DATA_PATH="${DATA_PATH:-${REPO_ROOT}/data/LLaVA-OneVision-1.5-Mid-Training-Webdataset-Quick-Start-3M}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/llava_ov15/reasonsiglip/stage1_5_midtraining}"
