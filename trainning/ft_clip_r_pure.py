...
def parse_args():
    ...
    parser.add_argument("--run_name", type=str, default="clip-R-finetune", 
    ...
    parser.add_argument("--hub_model_name", type=str, default="clip-R-pure-L14", 
...
def train_clip(args):
    ...
    if hasattr(args, 'dataset_name') and args.dataset_name:
        try:
            ...
            # 如果数据集没有预定义分割，则手动分割
            split_ds = raw_ds["train"].train_test_split(test_size=0.02, seed=42)
    ...
    training_args = TrainingArguments(
        ...
        metric_for_best_model="loss",  # 使用验证损失作为指标
