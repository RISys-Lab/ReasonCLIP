"""CLIP S1-unfreeze merged model inference smoke."""
...
pretrained = "/home/localadmin/bz/ReasonCLIP/llava_next/checkpoints/merged/clip_qwen3_s1_unfreeze_sft"
model_name = "qwen3"
device = "cuda"
device_map = "auto"
...
# This checkpoint already contains the S1-unfrozen CLIP vision tower.
# Do not overwrite it with fresh openai/clip-vit-large-patch14-336 weights.
