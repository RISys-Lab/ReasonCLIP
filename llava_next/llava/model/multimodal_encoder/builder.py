...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    vision_tower_name = vision_tower.split("/")[-1]
    if "clip-r" in vision_tower or vision_tower_name.startswith("RC-"):
        ...
        if use_s2:
            ...
            return CLIPVisionTower(vision_tower, args=vision_tower_cfg, **kwargs)
    elif "siglip" in vision_tower or vision_tower_name.startswith("RS-"):
