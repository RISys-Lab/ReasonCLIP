...
IMAGE_FOLDER="${IMAGE_FOLDER:-${CLIPR_ROOT}/data/llava-pretrain-data/images}"
DATA_PATH="${DATA_PATH:-${CLIPR_ROOT}/data/llava-pretrain-data/blip_laion_cc_sbu_558k.json}"

BASE_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-pretrain_blip558k_plain"
OUTPUT_DIR="${OUTPUT_DIR:-${CLIPR_ROOT}/llava_next/checkpoints/projectors/${BASE_RUN_NAME}}"
