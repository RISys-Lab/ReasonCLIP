...
| CLIP | base | ViT-L/14-336| [🤗 HF / OpenAI](https://example.com/model-1) | - |
...
| model | stage | scale | link | Recommended Tasks |
| --- | --- | --- | --- | --- |
| SigLIP | base | ViT-So400M/14 | [🤗 HF / Google](https://example.com/model-1)| - |
| ReasonSigLIP | Stage 1 | ViT-So400M/14 | [🤗 HF / ReasonSigLIP-So14-S1](https://huggingface.co/RISys-Lab/ReasonSigLIP-So14-S1) | 📖 For Compostitional Reasoning Tasks |
| ReasonSigLIP | Stage 2 | ViT-So400M/14 | [🤗 HF / ReasonSigLIP-So14-S2](https://huggingface.co/RISys-Lab/ReasonSigLIP-So14-S2)| ✅ For Comprehensive Tasks |
| ReasonSigLIP | Stage 0 - Reasoning | ViT-So400M/14 | [🤗 HF / ReasonSigLIP-So14-S0-Rea](https://huggingface.co/RISys-Lab/ReasonSigLIP-So14-S0-Rea)| - |
| ReasonSigLIP | Stage 0 - Descriptive | ViT-So400M/14 | [🤗 HF / ReasonSigLIP-So14-S0-Des](https://huggingface.co/RISys-Lab/ReasonSigLIP-So14-S0-Des) | - |
| SigLIP2 | base | ViT-So400M/14 | [🤗 HF / Google](https://example.com/model-1) | - |
| ReasonSigLIP2 | Stage 1 | ViT-So400M/14 | [🤗 HF / ReasonSigLIP2-So14-S1](https://huggingface.co/RISys-Lab/ReasonSigLIP2-So14-S1) | 📖 For Compostitional Reasoning Tasks|
| ReasonSigLIP2 | Stage 2 | ViT-So400M/14 | [🤗 HF / ReasonSigLIP2-So14-S2](https://huggingface.co/RISys-Lab/ReasonSigLIP2-So14-S2) | ✅ For Comprehensive Tasks |
| ReasonSigLIP2 | Stage 0 - Reasoning | ViT-So400M/14 | [🤗 HF / ReasonSigLIP2-So14-S0-Rea](https://huggingface.co/RISys-Lab/ReasonSigLIP2-So14-S0-Rea) | - |
| ReasonSigLIP2 | Stage 0 - Descriptive | ViT-So400M/14 | [🤗 HF / ReasonSigLIP2-So14-S0-Des](https://huggingface.co/RISys-Lab/ReasonSigLIP2-So14-S0-Des) | - |
| SigLIP2 | base | ViT-Giant-Opt/16 | [🤗 HF / Google](https://example.com/model-1) | - |
| ReasonSigLIP2 | Stage 1 | ViT-Giant-Opt/16 | [🤗 HF / ReasonSigLIP2-GO16-S1](https://huggingface.co/RISys-Lab/ReasonSigLIP2-GO16-S1) | 📖 For Compostitional Reasoning Tasks|
| ReasonSigLIP2 | Stage 2 | ViT-Giant-Opt/16 | [🤗 HF / ReasonSigLIP2-GO16-S2](https://huggingface.co/RISys-Lab/ReasonSigLIP2-GO16-S2) | ✅ For Comprehensive Tasks |
| ReasonSigLIP2 | Stage 0 - Reasoning | ViT-Giant-Opt/16 | [🤗 HF / ReasonSigLIP2-GO16-S0-Rea](https://huggingface.co/RISys-Lab/ReasonSigLIP2-GO16-S0-Rea) | - |
| ReasonSigLIP2 | Stage 0 - Descriptive | ViT-Giant-Opt/16 | [🤗 HF / ReasonSigLIP2-GO16-S0-Des](https://huggingface.co/RISys-Lab/ReasonSigLIP2-GO16-S0-Des) | - |
